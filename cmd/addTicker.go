...
// addTickerCmd represents the addTicker command
...
func init() {
	...
	// addTickerCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// addTickerCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
